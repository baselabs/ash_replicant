defmodule AshReplicant.TestRepo.Migrations.InstallAshOnetime do
  use Ecto.Migration
  ...
  defp create_cleanup_functions do
    ...
    BEGIN
      ...
      WITH candidates AS (
        ...
        USING candidates
        WHERE claims.logical_partition = candidates.logical_partition AND claims.operation_hash = candidates.operation_hash AND claims.id = candidates.id
        RETURNING claims.id
      )
